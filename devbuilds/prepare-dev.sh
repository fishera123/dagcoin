...
if [ -f "constants/$environment.constants.js" ]; then
  echo "${Green}* Copying ${1} configuration in core ...${CloseColor}"
  cp "constants/$environment.constants.js" "node_modules/byteballcore/constants.js"
fi
